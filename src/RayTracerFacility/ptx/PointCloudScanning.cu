...
namespace RayTracerFacility {
    extern "C" __constant__ DefaultPointCloudScanningLaunchParams defaultPointCloudScanningLaunchParams;
...
#pragma region Main ray generation
    extern "C" __global__ void __raygen__pointCloudScanning() {
        ...
        optixTrace(defaultPointCloudScanningLaunchParams.m_traversable,
                   rayOrigin,
                   rayDirection,
                   1e-3f,    // tmin
                   1e20f,  // tmax
                   ...
                   static_cast<int>(DefaultPointCloudScanningRayType::RadianceRayType),             // SBT offset
                   static_cast<int>(DefaultPointCloudScanningRayType::RayTypeCount),               // SBT stride
                   static_cast<int>(DefaultPointCloudScanningRayType::RadianceRayType),             // missSBTIndex
                   u0, u1);
