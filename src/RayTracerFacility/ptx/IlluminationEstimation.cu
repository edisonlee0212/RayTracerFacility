  ...
  case MaterialType::Default: {
    ...
    if (perRayData.m_hitCount <=
      ...
      optixTrace(
          ...
          static_cast<int>(
              IlluminationEstimationRayType::RadianceRayType), // SBT offset
          static_cast<int>(
              IlluminationEstimationRayType::RayTypeCount), // SBT stride
          static_cast<int>(
              IlluminationEstimationRayType::RadianceRayType), // missSBTIndex
          u0, u1);
      energy +=
          glm::clamp(
