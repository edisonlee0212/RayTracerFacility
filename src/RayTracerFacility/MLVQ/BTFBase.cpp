...
#pragma region Load Data
    ...
    ParseIntData(prefix + "_PDF6Dslices.txt", m_pdf6.m_numOfRows,
                 m_pdf6.m_numOfCols, minIntVal, maxIntVal, m_pdf6.m_pdf6DSlices);
    ParseFloatData(prefix + "_PDF6Dscale.txt", m_pdf6.m_numOfRows,
                   m_pdf6.m_numOfCols, minFloatVal, maxFloatVal, m_pdf6.m_pdf6DScale);
    m_pdf6.m_pdf6DSlicesBuffer.Upload(m_pdf6.m_pdf6DSlices);
    m_pdf6.m_pdf6DScaleBuffer.Upload(m_pdf6.m_pdf6DScale);
    m_pdf6.m_devicePdf6DSlices =
            reinterpret_cast<int *>(m_pdf6.m_pdf6DSlicesBuffer.DevicePointer());
    m_pdf6.m_devicePdf6DScale =
    ...
    ParseFloatData(prefix + "_PDF1Dslice.txt", pdf1.m_numOfPdf1D,
                   pdf1.m_numOfBeta, minFloatVal, maxFloatVal, pdf1.m_pdf1DBasis);
    pdf1.m_pdf1DBasisBuffer.Upload(pdf1.m_pdf1DBasis);
    ...
    ParseFloatData(prefix + "_colors.txt", ab.m_numOfColors, ab.m_numOfChannels,
                   minFloatVal, maxFloatVal, ab.m_vectorColorBasis);
    ab.m_vectorColorBasisBuffer.Upload(ab.m_vectorColorBasis);
    ...
    ParseIntData(prefix + "_indexAB.txt", iab.m_numOfIndexSlices, iab.m_numOfBeta,
                 minIntVal, maxIntVal, iab.m_indexAbBasis);
    iab.m_indexAbBasisBuffer.Upload(iab.m_indexAbBasis);
    ...
    ParseIntData(prefix + "_PDF2Dcolours.txt", pdf2.m_color.m_numOfPdf2D,
                 pdf2.m_color.m_numOfAlpha, minIntVal, maxIntVal, pdf2.m_color.m_pdf2DColors);
    pdf2.m_color.m_pdf2DColorsBuffer.Upload(pdf2.m_color.m_pdf2DColors);
    pdf2.m_color.m_devicePdf2DColors =
    ...
    ParseIntData(prefix + "_PDF2Dslices.txt", pdf2.m_luminance.m_numOfPdf2D,
                 pdf2.m_luminance.m_numOfAlpha, minIntVal, maxIntVal, pdf2.m_luminance.m_pdf2DSlices);
    pdf2.m_luminance.m_pdf2DSlicesBuffer.Upload(pdf2.m_luminance.m_pdf2DSlices);
    pdf2.m_luminance.m_devicePdf2DSlices = reinterpret_cast<int *>(
    ...
    ParseFloatData(prefix + "_PDF2Dscale.txt", pdf2.m_luminance.m_numOfPdf2D,
                   ...
                   pdf2.m_luminance.m_pdf2DScales);
    pdf2.m_luminance.m_pdf2DScalesBuffer.Upload(pdf2.m_luminance.m_pdf2DScales);
    pdf2.m_luminance.m_devicePdf2DScales = reinterpret_cast<float *>(
    ...
    pdf2.m_indexLuminanceColorBuffer.Upload(pdf2.m_indexLuminanceColors);
    ...
    ParseFloatData(prefix + "_PDF3Dscale.txt", pdf3.m_numOfPdf3D,
                   pdf3.m_numOfTheta, minFloatVal, maxFloatVal, pdf3.m_pdf3DScales);
    pdf3.m_pdf3DScalesBuffer.Upload(pdf3.m_pdf3DScales);
    ...
    ParseIntData(prefix + "_PDF3Dslices.txt", pdf3.m_numOfPdf3D,
                 pdf3.m_numOfTheta, minIntVal, maxIntVal, pdf3.m_pdf3DSlices);
    pdf3.m_pdf3DSlicesBuffer.Upload(pdf3.m_pdf3DSlices);
    ...
    ParseFloatData(prefix + "_PDF4Dscale.txt", pdf4.m_numOfPdf4D, pdf4.m_numOfPhi,
                   minFloatVal, maxFloatVal, pdf4.m_pdf4DScales);
    pdf4.m_pdf4DScalesBuffer.Upload(pdf4.m_pdf4DScales);
    ...
    ParseIntData(prefix + "_PDF4Dslices.txt", pdf4.m_numOfPdf4D, pdf4.m_numOfPhi,
                 minIntVal, maxIntVal, pdf4.m_pdf4DSlices);
    pdf4.m_pdf4DSlicesBuffer.Upload(pdf4.m_pdf4DSlices);
